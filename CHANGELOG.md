...
## [3.0.3] - TBD
- update_certification_status admin command updating certification status based on AssessmentDate and email 
  notification to maintainers about centre's certification expiring
- well controlled vocabulary for Centre's Type Status
- reordering admin fields according to request
- hide artifact fields from admin view - to be removed in next release to avoid data inconsistencies 
- historical models
