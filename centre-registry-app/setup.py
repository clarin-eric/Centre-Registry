...
INSTALL_REQUIRES = ['Django==2.2.23', 'django-debug-toolbar==2.2.1']
...
setup(
    ...
    author=['Michał Gawor', 'André Moreira', 'Sander Maijers', 'Beatriz Sanchez Bribian'],
