...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                ('strict_versioning',
                 models.BooleanField(default=False,
                                     verbose_name='Strict versioning?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_observer', models.BooleanField(
                    default=False,
                    verbose_name='Is observer (not member)?')),
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, ), ),
        migrations.CreateModel(name='MetadataFormat',
                               fields=[
                                   ('id', models.AutoField(serialize=False,
                                                           primary_key=True,
                                                           auto_created=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('centre', models.ForeignKey(to='centre_registry.Centre')),
                ('metadata_format',
                 models.ForeignKey(to='centre_registry.MetadataFormat',
                                   verbose_name='Metadata format')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saml_metadata_url',
                 models.URLField(max_length=1024,
                                 verbose_name='SAML metadata URL')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False,
                                        ...
                                        auto_created=True,
                                        verbose_name='ID')),
                ('entity_id', models.URLField(max_length=1024,
                                              unique=True,
                                              verbose_name='Entity ID')),
                ('status_url', models.URLField(max_length=1024,
                                               blank=True,
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, ), ),
        migrations.AddField(model_name='samlidentityfederation',
