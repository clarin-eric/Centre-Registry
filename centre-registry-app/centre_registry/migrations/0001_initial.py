    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shorthand', models.CharField(max_length=20, unique=True, verbose_name='Shorthand code')),
                ...
                ('latitude', models.CharField(max_length=20, validators=[centre_registry.models.validate_latitude],
                                              verbose_name='Latitude')),
                ('longitude', models.CharField(max_length=20, validators=[centre_registry.models.validate_longitude],
                                               verbose_name='Longitude')),
                ('type_status',
                 models.CharField(max_length=100, blank=True, verbose_name="Comments about centre's type")),
                ...
                ('expertise', models.CharField(max_length=200, blank=True, verbose_name='Expertise')),
                ('type_certificate_url',
                 models.URLField(max_length=2000, blank=True, verbose_name='Centre type certificate URL')),
                ('dsa_url', models.URLField(max_length=2000, blank=True, verbose_name='Data Seal of Approval URL')),
                ('pid_status',
                 models.CharField(max_length=200, blank=True, verbose_name='Persistent Identifier usage status')),
                ('long_term_archiving_policy',
                 models.CharField(max_length=200, blank=True, verbose_name='Long Time Archiving Policy')),
                ('repository_system', models.CharField(max_length=200, blank=True, verbose_name='Repository system')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website_url', models.URLField(max_length=2000, verbose_name='Website URL')),
                ('alias', models.CharField(max_length=25, verbose_name='Alias (... .clarin.eu)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.URLField(max_length=2000, blank=True, verbose_name='Website')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True, auto_created=True, verbose_name='ID')),
                ('web_services_set', models.CharField(max_length=100, blank=True, verbose_name='Web services set')),
                ('web_services_type',
                 models.CharField(max_length=10, blank=True, verbose_name='Web services type (e.g. SOAP; REST)')),
                ('uri', models.URLField(max_length=2000, unique=True, verbose_name='Base URI')),
                ('centre', models.ForeignKey(to='centre_registry.Centre')),
                ('metadata_format',
                 models.ForeignKey(to='centre_registry.MetadataFormat', verbose_name='Metadata format')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True, auto_created=True, verbose_name='ID')),
                ('entity_id', models.URLField(max_length=1024, unique=True, verbose_name='Entity ID')),
                ('status_url', models.URLField(max_length=1024, blank=True, verbose_name='Status URL')),
                ('centre', models.ForeignKey(to='centre_registry.Centre')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='centre_registry.SAMLServiceProvider', blank=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='administrative_contact', to='centre_registry.Contact'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='centre',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='technical_contact', to='centre_registry.Contact'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='centre',
